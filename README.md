# Программно-аппаратный комплекс динамического 3D-измерения габаритов на конвейере (Ozon Tech Case)
...
Проект разработан в рамках квалификационного кейса **Ozon Tech** для автоматизации распределительных и сортировочных центров (Fulfillment & Sorting Centers).
...
## 📄 Лицензия
MIT License. Разработано для квалификационного отбора в команду Computer Vision Ozon Tech.
